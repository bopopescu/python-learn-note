...
#Created Time: 2019-01-10 13:51:33
############################
class Advise(object):
...
# BufferTooLargeInTheory=您的系统可用内存为{0}，您的配置参数max_connections为{1}，理论上您的数据库最大占用内存为{2}，建议调整Innodb_buffer_pool_size,
# max_connections参数或者升级规格
#
# #
# 容量规划优化建议
...
# MySQLDeadLockWarning=您的数据库在过去{0}小时内，发生了{1}次死锁，死锁频率较高，可能影响数据库性能，您可以查看Error
# log找到死锁语句，请重新审核SQL语句，合理组织SQL语句的顺序
